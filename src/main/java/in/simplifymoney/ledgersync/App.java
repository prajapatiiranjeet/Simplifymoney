    ...
    public static void main(String[] args) throws Exception {
        ...
        switch (args[0]) {
            ...
            case "report" -> {
                ...
                List<in.simplifymoney.ledgersync.model.NormalizedTxn> ledger;
                if (args.length >= 3) {
                    in.simplifymoney.ledgersync.store.InMemoryLedgerStore memStore =
                            new in.simplifymoney.ledgersync.store.InMemoryLedgerStore();
                ...
                System.out.println("wrote 3 files to " + out + " (" + ledger.size() + " transactions)");
            }
            default -> {
