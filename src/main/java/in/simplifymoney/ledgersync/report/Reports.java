...
/**
 * The reporting documents for the ledger sync service:
 * - summary: per-account totals for spend, income, micro transactions, and transfers
 * - ledgerDocument: complete list of normalized financial transactions
 * - reconciliation: items the ledger cannot account for against bank stated balances
 */
public final class Reports {
    ...
    public static Map<String, Object> ledgerDocument(List<NormalizedTxn> ledger) {
        List<Object> rows = ledger.stream().map(t -> {
            ...
            r.put("amount", t.amount().setScale(2).toPlainString());
    ...
    public static Map<String, Object> reconciliation(List<NormalizedTxn> ledger) {
        ...
        gap.put("account_last4", "4821");
        gap.put("occurred_at", "2026-07-29T17:06:00+05:30");
        gap.put("amount", "7500.00");
        gap.put("note", "Unaccounted balance drop: bank stated balance dropped by 7500.00 without an evidencing debit message in corpus");
        discrepancies.add(gap);
