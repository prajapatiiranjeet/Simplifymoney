...
class AmountsTest {
    ...
    @Test
    void reproducesIncidentWaterCanSpendWithoutDecimals() {
        // INC-2026-09-11: Whole number rupees without decimals should extract Rs.5, not Avl Bal Rs.92,213.10
    ...
    @Test
    void readsWholeRupeesWithThousandsSeparator() {
        // INR 18,000 without decimal places should extract 18000.00, not Avl Bal Rs.49,882.25
